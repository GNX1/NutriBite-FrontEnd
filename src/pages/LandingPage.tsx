            ...
            <section className="py-20 px-6 md:px-16 bg-gradient-to-br from-slate-50 to-emerald-50/50">
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <button className="w-full bg-emerald-500 text-white font-bold py-3.5 rounded-2xl flex items-center justify-center gap-2 group-hover:bg-emerald-600 transition-colors shadow-lg shadow-emerald-200">
                            Launch User Dashboard <ArrowRight size={18} />
                        </button>
                    </motion.div>
                    ...
                    >
                        ...
                        <button className="w-full bg-slate-900 text-white font-bold py-3.5 rounded-2xl flex items-center justify-center gap-2 group-hover:bg-slate-700 transition-colors shadow-lg shadow-slate-900/10">
